...
cast(factura1.num_factura as char(25)) as docmto_aplicar, 
...
group by factura1.almacen, factura1.tipo, factura1.documento, factura1.cliente, 
factura1.fecha_factura, factura1.num_factura;
