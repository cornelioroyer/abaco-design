...
drop view v_pla_horarios_grupos_deg;
create view v_pla_horarios_grupo_deg as
select pla_tarjeta_tiempo.compania, pla_tarjeta_tiempo.codigo_empleado,
trim(trim(pla_empleados.nombre) || ' ' || trim(pla_empleados.apellido)) as nombre_colaborador, 
...
and pla_periodos.numero_planilla = 19
and pla_tarjeta_tiempo.codigo_empleado = '0093'
