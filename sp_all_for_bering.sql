...
create trigger t_cgl_comprobante1_after_update after update on cgl_comprobante1
...
begin
    ...
    and estado = ''I'';
    if found then
       raise exception ''Fecha % corresponde a un periodo cerrado no se puede eliminar en la cia %...Verifique'',old.fecha_comprobante, old.compania;
    end if;
