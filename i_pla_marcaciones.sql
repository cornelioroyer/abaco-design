...
compania, turno, entrada, salida, entrada_descanso, salida_descanso, status, autorizado)
select pla_marcaciones3.id_tarjeta_de_tiempo, id_pla_proyectos,
pla_marcaciones3.compania, turno, entrada, salida, entrada_descanso, salida_descanso, pla_marcaciones3.status, autorizado
